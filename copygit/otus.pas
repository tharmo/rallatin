...
begin
 ...
 iF OnJO[i]=0 then
  begin
   ...
   for j:=2 to 62 do        //1 vai 0 ... k‰ki kukkuu
  ...
  begin
     ...
     try
      ...
      counted:=0;
      for j:=1 to 127 do if mx[maxis[i].w*cols+j].w=0 then BREAK ELSE //30 isointa merkataan k‰ytetyiksi
      begin
        //if mx[maxis[i].w*cols+j].v>bval div 15 then  //mik‰ ois hyv‰ kynnysarvo?
        begin
